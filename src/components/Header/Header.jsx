  ...
  render(){
    return (
      <div className="Header">
        ...
        <h3>Explore recent pictures uploaded to <a href="https://www.flickr.com/">flickr</a>, <br/>
        ...
        <a href="https://redux.js.org/"> Redux</a>.  Back end made with <a href="https://koajs.com/">Koa</a>.
